...
public class GetUserServlet extends SlingAllMethodsServlet {
	...
	protected void doPost(final SlingHttpServletRequest request,
		...
		try {
			...
			String token = (String) ehcacheManager.getElementFromCache(cacheName, GlobalConstants.TOKEN_CACHE_NAME);
			...
			//headers.put("Authorization", "OAuth e19a73c4-ea65-48a4-8edb-3fc8d337201f");
